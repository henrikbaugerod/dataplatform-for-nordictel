...
The 'nordicteldemo' project was generated by using the dbt template for
...
3. Install dbt
   ...
   Run these instructions from the `nordicteldemo` directory. We recommend making
...
`[dev yourname] nordicteldemo_job` to your workspace.
...
When deploying to this target, note that the default job at resources/nordicteldemo.job.yml
